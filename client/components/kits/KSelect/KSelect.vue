  ...
  >
    ...
    >
      ...
      >
        ...
        <v-progress v-if="loading" class="control__loading" determinate />
      </div>
      ...
      <div
        ...
        @mousedown.prevent
      >
        <span v-if="!localItems.length" class="k-select__message">
          موردی یافت نشد
        </span>
  ...
  computed: {
    ...
    localItems() {
      return this.items.filter((i) =>
        i[this.itemText].includes(this.searchText)
      )
    },
...
<style src="./KSelect.scss" lang="scss" />
